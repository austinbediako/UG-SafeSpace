...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-[#153D6F] w-[260px] shrink-0",
        className
      )}
...
export const SidebarLink = ({
  ...
  return (
    ...
    >
      {/* Wrap icon in a fixed pill when collapsed + active */}
      {collapsed && active ? (
...
/* Section header — shows label when expanded, thin divider when collapsed */
